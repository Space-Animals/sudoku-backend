"""
Django settings for sudoku-backend project.
...
if os.getenv('ENV') == 'development':
  ...
  DEBUG = False
  CORS_ORIGIN_WHITELIST = [os.getenv('CLIENT_ORIGIN'), 'https://space-animals.github.io/sudoku-frontend']
...
ROOT_URLCONF = 'sudoku-backend.urls'
...
WSGI_APPLICATION = 'sudoku-backend.wsgi.application'
